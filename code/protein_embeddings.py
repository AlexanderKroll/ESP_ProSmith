...
def calculate_protein_embeddings(all_sequences, prot_emb_no = 1000):
    ...
    model, alphabet = esm.pretrained.load_model_and_alphabet_local(model_location = join(BASE_DIR, "data", "saved_models", "ESM1b", "esm1b_t33_650M_UR50S.pt"))
    model.eval()
